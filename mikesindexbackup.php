    ...
    <body>
        ...
        <div id="header">
            ...
            <form class="form-horizontal" role="form" id="mainForm">
                ...
                <!-- Type of search pulldown menu -->
                <div class="form-group">
                    <div class="col-lg-2">
                      <select class="form-control" id="ChooseSearch" size="1">
                ...
                <div class="searchInputs">
          	    <div class="form-group col-lg-8">
                    ...
                    <div id="select_location">
                        <div class="col-lg-10">
                      <input type="text" class="form-control" id="SearchLocation" placeholder="Search where: (location)">
                        </div>
                    </div>
                    </div>
                    
                <div class="searchInputs2">
                    <div class="col-lg-5">
                    ...
                    <div class="col-lg-6">
                      <input type="text" class="form-control" id="SearchResultsRadius" placeholder="Radius (in mi)">
                    </div>
                </div>
                </div>
